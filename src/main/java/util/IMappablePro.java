...
// Possiamo accedere direttamente ai metodi, costruttori e proprietà di una classe
		...
		for (Method metodo : metodi) {
			...
			if (!nomeMetodo.equalsIgnoreCase("getclass") && 
				...
				try {
					...
					// con substring eliminerò il get e rimarrà Foo
